...
SFS_EXT_LIBS = $(wildcard $(SFS_EXT_LIB_DIR)/*.jar)
sfsjarfilter = $(call excludefiles,$(SFS_LIBS) $(SFS_EXT_LIBS),$1)
excludefiles = $(filter-out $(addprefix %/,$(notdir $1)),$2)
...
$1_DST_LIBS = $$(addprefix $$($1_EXT_DIR)/,$$(notdir $$($1_LIBS)))
...
$$($1_DST_LIBS):: $$($1_LIBS) |$$($1_EXT_DIR)
	$$(call silent,COPY $4 libs,cp $$^ $$($1_EXT_DIR))
...
sfs-mkdebug::
	@echo "$1_LIBS: $$($1_LIBS)"
	@echo "$1_DST_LIBS: $$($1_DST_LIBS)"
	@echo "$1_DST_ZONE: $$($1_DST_ZONE)"
	@echo "$1_DST_JAR_: $$($1_DST_JAR_)"
